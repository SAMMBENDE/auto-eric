              ...
              <div className="w-full space-y-6 pb-6 sm:max-w-md sm:pr-5 md:space-y-4 md:pb-0 lg:max-w-lg lg:space-y-8 lg:pr-0 xl:space-y-9">
                <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                  <span className="block xl:inline">
                    Awesome Cars at unimaginable Prices
                  </span>
                ...
                <p className="mx-auto text-base text-gray-500 sm:max-w-md md:max-w-3xl lg:text-xl">
                  We carry a full line of quality Toyota used cars as well as
                  car accessories, decorations and other services.
                </p>
                <div className="relative flex flex-col sm:flex-row sm:space-x-4">
                  <a
                    href="#/"
                    className="transistion mb-3 flex w-full items-center rounded-md bg-yellow-400 px-6 py-3 text-lg text-black delay-150 duration-300 ease-in-out  hover:scale-110 hover:bg-yellow-400 hover:text-white sm:mb-0 sm:w-auto"
                  >
                    See Our Collection
                    <svg
